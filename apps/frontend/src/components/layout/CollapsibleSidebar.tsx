...
const navItems = [
    ...
    { icon: Workflow, label: 'All Strategies', path: '/strategies' },
    { icon: LineChart, label: 'Fair Value', path: '/fair-value' },
    { icon: Zap, label: 'Atomic Arb', path: '/atomic-arb' },
    { icon: Activity, label: 'OBI Scalper', path: '/obi-scalper' },
    { icon: Brain, label: 'CEX Sniper', path: '/cex-sniper' },
    { icon: History, label: 'Maker MM', path: '/maker-mm' },
